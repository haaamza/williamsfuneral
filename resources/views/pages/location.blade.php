...
<title>Williams Funeral Home, Inc. | Directions</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h6 style="font-size:28px;margin-top:10px;color:#1a4b5d;">Directions</h6>
      </div>
    </div>
  </div>
</div>
...
<div class="main-container" style="background-color:white;"><!-- main container -->
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12  location"><!-- content -->
        <div class="row">
          <div class="col-md-12">
            ...
            <h2 style="text-align:center;color:#1a4b5d;">Directions to Williams Funeral Home, Inc.</h2>
            <p style="text-align:center;">Williams Funeral Home, Inc. <br>821 N Main St <br>Sumter, SC 29150</p>
          </div>
        </div>

        <div class="col-md-12">
          <div class="well-default">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3310.067873011837!2d-80.34517564865463!3d33.939382380541794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88ff6f680fe85767%3A0x2e7698d8d54b4ae8!2sWilliams%20Funeral%20Home!5e0!3m2!1sen!2s!4v1567370288683!5m2!1sen!2s" width="1050" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
          </div>
        </div>

        <div class="row">

          <div class="col-md-6 location-add">
            <div class="well-default">
              <h2 class="well-title">Funeral Support</h2>
              <p>If you'd like to speak to us directly, call free 24 hours a day.</p>
              <div class="call-list"><i class="fa fa-phone"></i> 803-773-6422</div>
              <div class="email-list"><i class="fa fa-envelope"></i> info@funeral.com</div>
            </div>
          </div>

          <div class="col-md-6 location-add">
            <div class="well-default">
              <h2 class="well-title">Timing Hours</h2>
              <p>You can visit us in these hours in a week. </p>
              <div class="call-list"> Monday - Friday <span style="float:right;margin-right:10px;"><p>8:30am - 5:00pm</p></div>
              <div class="email-list"> Monday - Friday <span style="float:right;margin-right:10px;"><p>8:30am - 5:00pm</p></div>
            </div>
          </div>
...
<script type="text/javascript" src="js/location-carousel.js"></script>
<!-- jQuery -->
<script type="text/javascript" src="js/jquery.smartmenus.min.js"></script>
<!-- SmartMenus jQuery plugin -->
<script type="text/javascript" src="js/jquery.smartmenus.bootstrap.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-MyK9X5A73b98SDYmIHtLHfOo15VluH4&callback=myMap"></script>
</body>
</html>
