...
<title>Williams Funeral Home, Inc. | Contact Us</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h6 style="font-size:28px;margin-top:10px;">Contact Us</h6>
      </div>
    </div>
  </div>
</div>
...
<div class="col-12">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10">
        <h1 style="color:#1a4b5d;text-align:center;margin-top:30px;">Contact Us</h1>
        <p style="text-align:center;">You can use this page to forward your questions and comments to Williams Funeral Home, Inc.. Please mention any subjects for which you wish to obtain more information.</p>
      </div>
      <div class="col-md-1"></div>
      ...
      <div class="col-md-12 contact-form">
        ...
        <div class="row">
          <form method="post" action="contact-us.php">
            ...
            <div class="form-group col-md-6">
              <label class="control-label" for="subject" style="font-size:18px;">Subject:</label>
              <span class="required">*</span>
              <input id="subject" name="subject" type="text" placeholder="" class="form-control input-md">
            </div>
            <!-- Textarea -->
            <div class="col-md-12 form-group">
              <label class="control-label" for="comment" style="font-size:18px;">Questions or Comment:</label>
              <textarea class="form-control" id="comment" name="comment" rows="9"></textarea>
            </div>
            <!-- Text input-->
            <div class="col-md-4">
