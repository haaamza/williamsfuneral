...
<title>Williams Funeral Home, Inc. | Pre Planning Form</title>
    ...
    <div class="row">
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Pre Planning Form</li>
        </ol>
      </div>
    </div>
  </div>
...
<div class="col-12">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10">
        <h1 style="color:#1a4b5d;text-align:center;margin-top:30px;">Pre Planning Form</h1>
