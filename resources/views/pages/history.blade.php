...
<title>Williams Funeral Home, Inc. | Family History</title>
          ...
          <div class="col-md-12">
            <div class="sidenav widget">
              <ul class="nav nav-stacked listnone angle-right">
                ...
                <li class="active"><a href="{{route('history')}}" title="Family History">Family History</a></li>
                <li><a href="{{route('staffHistory')}}" title="Staff History">Staff History</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="well-default">
              <div class="row">
                <div class="col-md-3 history-year">
                  <img src="images/service-icon-8.png">
                </div>
                <div class="col-md-9 history-info">
                  <h2>Rev. Frank Williams, Jr., <span><b>President</b></span> </h2>
                  <p>Proin dictum dapibus dolor id sodales mauris vestibulum etuspendisse allow ullamcorper nisl felisit amet congue justo lacinia necorbi sed magna tibulum suscipit lacuseget posuere augue. </p>
                </div>
              </div>
            </div>
            <div class="well-default">
              <div class="row">
                ...
                <div class="col-md-9 history-info">
                  <h2>Rev. James E. Williams </h2>
                  <p>Suspendisse ullamcorper nisl felis sitamet congue justo lacinia necorbi sed magna tibulum suscipit lacus eget posuere augue uscrisus on lorem justog
                    na suscipit lacus eget posuere augue. </p>
                </div>
              </div>
            </div>
            <div class="well-default">
              <div class="row">
                ...
                <div class="col-md-9 history-info">
                  <h2>Rev. Sandra Williams-Brailsford, <span><b>Treasurer, Secretary</b></span></h2>
                  <p>Lorem ipsum dolor sitamet consectetur adipiscing elit nteger eteleifend elita aliquet quamnteger mollisnulla nonrisus maximus tincidunt ullam acsapien accumsan aliquam lacusurnusce auctorlacus enim. </p>
                </div>
              </div>
            </div>
            <div class="well-default">
              <div class="row">
                ...
                <div class="col-md-9 history-info">
                  <h2>Rev. Frank E. Williams, Sr. <span><b>Deceased</b></span></h2>
                  <p>Duis ultrices dictum magna, idtempor arcu lacinia euenean finibus bibendum neque id placerat purus finibus aellentesque sagittis hendrerit mauris et portauis condimentum, augue etauctor molestie justo neque condimentum sem vulputate iaculis estelit sitamet sapien. </p>
                </div>
              </div>
            </div>
            <div class="well-default">
              <div class="row">
                ...
                <div class="col-md-9 history-info">
                  <h2>Mrs. Magnolia R. Williams <span><b>Deceased</b></span></h2>
                  <p>Duis ultrices dictum magna, idtempor arcu lacinia euenean finibus bibendum neque id placerat purus finibus aellentesque sagittis hendrerit mauris et portauis condimentum, augue etauctor molestie justo neque condimentum sem vulputate iaculis estelit sitamet sapien. </p>
                </div>
              </div>
            </div>
