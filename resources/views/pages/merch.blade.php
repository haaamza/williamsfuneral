...
<title>Williams Funeral Home, Inc. | Merchandise</title>
      ...
      <div class="row portfolioContainer">
        <div class="All col-md-4">
          <div class="gallery-pics">
            <div class="gallery-pic"><img src="images/casket1.jpg" alt="" class="img-responsive">
        ...
        <div class="melbourne sydney col-md-4">
          <div class="gallery-pics">
            <div class="gallery-pic"><img src="images/casket2.jpg" alt="" class="img-responsive">
              <div class="gallery-caption">
                <div class="blur"></div>
                <div class="caption-text">
                  <h2>Heading Title here</h2>
        ...
        <div class="sydney adelaide col-md-4">
          <div class="gallery-pics">
            <div class="gallery-pic"><img src="images/casket3.jpg" alt="" class="img-responsive">
              <div class="gallery-caption">
                <div class="blur"></div>
                <div class="caption-text">
                  <h2>Heading Title here</h2>
