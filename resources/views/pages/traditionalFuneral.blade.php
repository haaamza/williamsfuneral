...
<title>Williams Funeral Home, Inc. | Traditional Funerals</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h6 style="font-size:28px;margin-top:10px;">Traditional Full Length Funeral</h6>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Full Length Funeral</li>
        </ol>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            <p>In life, every goodbye is different and the same is true when arranging a funeral goodbye, whether that’s for a loved one or your own.</p>
            <div class="service-img"> <img src="images/funeral.jpg" class="img-responsive" alt> </div>
            <h2 style="color:#1a4b5d;">Things you should think about</h2>
            <p>This type of funeral, often referred to by funeral providers as a traditional funeral, usually includes a viewing or visitation and formal funeral service, use of a hearse to transport the body to the funeral site and cemetery, and burial, entombment or cremation of the remains.</p>
            <p>It is important that you choose the funeral ceremony that is right for you and your family. Williams Funeral Homes can guide you through the choices available, and will take care of all the details. </p>
            <h2 style="color:#1a4b5d;">We can take care of the following details</h2>
            <ul class="listnone check-circle-o">
              <li>Funeral home's basic services fee</li>
              <li>Embalming and dressing the body</li>
              <li>Rental of the funeral home for the viewing or service</li>
              <li>Use of vehicles to transport the family</li>
              <li>The costs of a casket</li>
              <li>Cemetery plot or crypt</li>
              <li>Other funeral goods and services</li>
            </ul>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="row">
          <div class="col-md-12 widget-support"><!-- widget support -->
            <div class="widget">
              <h3 class="widget-title widget-support-title">Funeral Support</h3>
              <p>If you'd like to speak to us directly, call free 24 hours a day.</p>
              <div class="widget-call"> <i class="fa fa-phone"></i> 1800-123-4567 / 6789 </div>
              <div class="widget-email"> <i class="fa fa-envelope"></i> <a href="#">info@funeral.com</a> </div>
            </div>
          </div>
          <!-- /.widget support -->
          ...
          <div class="col-md-12 widget-plans"><!-- widget plans -->
            <div class="widget">
              <h3 class="widget-title widget-plans-title">Funeral Plans</h3>
                ...
                <img src="images/master.jpg" id="imagesSpecial">

                <img src="images/visa.jpg" id="imagesSpecial">

                <p style="margin-top:20px;">William Funeral Homes accept all major credit cards.</p>

              <!-- <ul class="list-group">
                <li class="list-group-item odd-bg"> <span class="plans-badge">$ 2300</span> Simple Plan
                  <div><strong class="minits">(included details)</strong></div>
                </li>
                <li class="list-group-item even-bg"> <span class="plans-badge">$ 3700</span> Mid-Range Plan
                  <div><strong class="minits">(included details)</strong></div>
                </li>
                <li class="list-group-item odd-bg"> <span class="plans-badge">$ 4200</span> Super Plan
                  <div><strong class="minits">(included details)</strong></div>
                </li>
              </ul> -->


              <!-- <a href="" class="btn btn-default">view funeral plan</a> </div> -->


          </div>
          <!-- /.widget plans -->

          <div class="col-md-12 widget-directors"><!-- widget directors -->
            <div class="widget">
              <h3 class="widget-title widget-plans-title">Funeral directors</h3>
              <p>Our friendly team of fully trained staff share our drive to provide service.</p>
              <a href="staffhistory.html" class="btn btn-default">check the staff</a> </div>
          </div>
          <!-- /.widget directors -->
