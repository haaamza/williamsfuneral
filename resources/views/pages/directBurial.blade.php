...
<title>Williams Funeral Home, Inc. | Burials</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h6 style="font-size:28px;margin-top:10px;color:#1a4b5d;">Direct Burials</h6>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Direct Burials</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="service-img"> <img src="images/burials.jpg" class="img-responsive" alt> </div>
            <h2 style="color:#1a4b5d;">Things you should think about</h2>
            <p>The body is buried shortly after death, usually in a simple container. No viewing or visitation is involved, so no embalming is necessary.</p>
            <p>A memorial service may be held at the graveside or later. Direct burial usually costs less than the A traditional, full-service funeral.</p>
            ...
            <ul class="listnone check-circle-o">
              ...
              <li>Purchase of a casket or burial container</li>
              <li>Cemetery plot or crypt</li>
              <li>Other funeral goods and services</li>
              <li>If the family chooses to be at the cemetery for the burial, the funeral home often charges an additional fee for a graveside service.</li>
            </ul>
          </div>
        </div>
      </div>
