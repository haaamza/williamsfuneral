...
<title>Williams Funeral Home, Inc. | Cremation</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h6 style="font-size:28px;margin-top:10px;">Direct Cremation</h6>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Direct Cremation</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="service-img"> <img src="images/crematory.jpg" class="img-responsive" alt> </div>
            <h2 style="color:#1a4b5d;">Things you should think about</h2>
            <p>The body is cremated shortly after death, without embalming. The cremated remains are placed in an urn or other container. No viewing or visitation is involved, although a memorial service may be held, with or without the cremated remains present.</p>
            <p>The remains can be kept in the home, buried or placed in a crypt or niche in a cemetery, or buried or scattered in a favorite spot. Direct cremation usually costs less than the A traditional, full-service funeral.</p>
            ...
            <ul class="listnone check-circle-o">
              ...
              <li>Transportation of the body.</li>
              <li>Care of the body.</li>
              <li>The cost of a cemetery plot or crypt is included only if the remains are buried or entombed.</li>
              <li>Charges for an urn or other container.</li>
              <li>A crematory fee may be included or, if the funeral home does not own the crematory, the fee may be added on.</li>
              <li>Funeral providers who offer direct cremations also must offer to provide an alternative container that can be used in place of a casket.</li>
            </ul>
