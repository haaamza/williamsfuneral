...
<title>Williams Funeral Home, Inc. | Services</title>
...
<!-- /.page breadcrumb -->
<div class="section-space" style="background-color:#fff;">
  <div class="container">
    <div class="row">
      <div class="col-md-12 section-title">
        <h1>Choose Your Service</h1>
        <p style="margin-bottom:20px;">Every family is different, and not everyone wants the same type of funeral. Funeral practices are influenced by religious and cultural traditions, costs and personal preferences. These factors help determine whether the funeral will be elaborate or simple, public or private, religious or secular, and where it will be held. </p>
...
<div class="main-container" style="background-color:#fff;"><!-- main container -->
  <div class="container">
    <div class="row">
      <div class="col-md-4 service-thumb"><!-- service thumb -->
        <div class="service-block" style="background-color:#f3fcfe;padding:20px;border:1px solid #1a4b5d;"><!-- service block -->
          <div class="service-img2"><a href="traditionalfuneral.html" title="Service Image"><img src="images/casket1.jpg" class="img-responsive" alt></a></div>
          <div class="service-info">
            <h2><a href="traditionalfuneral.html" title="Service Title">Traditional Funeral</a></h2>
            <p>We’re here to help you from the moment you need us through every step of the way.</p>
            <a href="traditionalfuneral.html" class="btn btn-default">Read More</a> </div>
        </div>
        <!-- /.service block -->
      </div>
      <!-- /.service thumb -->
      ...
      <div class="col-md-4 service-thumb"><!-- service thumb -->
        <div class="service-block" style="background-color:#f3fcfe;padding:20px;border:1px solid #1a4b5d;"><!-- service block -->
          <div class="service-img2"><a href="directBurials.html" title="Service Image"><img src="images/casket2.jpg" class="img-responsive" alt></a></div>
          <div class="service-info">
            <h2><a href="directBurials.html" title="Service Title">Direct Burial</a></h2>
            <p>The body is buried shortly after death, usually in a simple container.</p>
            <a href="directBurials.html" class="btn btn-default">Read More</a> </div>
        </div>
        <!-- /.service block -->
      </div>
      <!-- /.service thumb -->
      ...
      <div class="col-md-4 service-thumb"><!-- service thumb -->
        <div class="service-block" style="background-color:#f3fcfe;padding:20px;border:1px solid #1a4b5d;"><!-- service block -->
          <div class="service-img2"><a href="directCremation.html" title="Service Image"><img src="images/casket3.jpg" class="img-responsive" alt></a></div>
          <div class="service-info">
            <h2><a href="directCremation.html" title="Service Title">Direct Cremation</a></h2>
            <p>The body is cremated shortly after death, without embalming.</p>
            <a href="directCremation.html" class="btn btn-default">Read More</a> </div>
        </div>
        <!-- /.service block -->
      </div>
      <!-- /.service thumb -->
